  ...
  <include file="Common:Nav" />
    ...
    <div class="container">
      <form role="form" method="POST" enctype="multipart/form-data">
        <input type="hidden" name="mall" value="{$special['mall']}" />
        <div class="form-group">
          <label for="name">专题名称</label>
          <input type="text" name="name" value="{$special['name']}" class="form-control" placeholder="请输入专题名称" />
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          ...
          <textarea name="banner2" placeholder="请输入banner2内的HTML">{$special['banner2']}</textarea>
          ...
          <div class="mall-options">
            <if condition="$malls">
              <volist name="malls" id="mall">
                <label class="checkbox-inline"><input type="checkbox" class="mall-id-{$mall['id']}" value="{$mall['id']}" />{$mall['name']}</label>
              </volist>
            <else />
        ...
        <div class="form-group">
          ...
          <input type="text" name="order" value="{$special['rank_order']}" class="form-control" placeholder="排序ID，数字越小，越在前面" />
        </div>
