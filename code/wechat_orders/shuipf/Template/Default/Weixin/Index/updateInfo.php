        ...
        <fieldset>
                <div class="div-section pure-g">
                    ...
                    <div class="pure-u-3-4">
                         <input class="pure-input-1" name="name" id="name" type="text" placeholder="您的姓名" value="{$user['username']}">
                    </div>
                </div>
                ...
                <div class="div-section pure-g">
                    ...
                    <div class="pure-u-3-4">
                         <input name="mobile" id="mobile" class="pure-input-1" type="tel" placeholder="请填写真实有效的11位手机号码" value="{$user['mobile']}">
                    </div>
                </div>
                ...
                <div class="div-section pure-g">
                    ...
                    <div class="pure-u-3-4">
                         <input name="qq" id="qq" class="pure-input-1" type="tel" placeholder="您的常用QQ号码" value="{$user['qq']}">
                    </div>
                </div>
                <div class="div-section pure-g">
                    <div class="pure-u-1-4" style="padding-top: 5px;">
                    ...
                    <div class="pure-u-3-4">
                         <input name="loc" id="loc" value="{$user['loc']}" class="pure-input-1" type="text" placeholder="您的常用邮寄地址">
                    </div>
                </div>
                                <div class="div-section pure-g">
                    <div class="pure-u-1">
                        <button type="submit" class="pure-button pure-button-success pure-input-1">确认修改</button>
