...
.one-item-menu a {
  ...
  <body>
    ...
    <if condition="$special['banner1']">
      <div class="container checkout container-banner1">
        <img data-original="/upload/{$special['banner1']}" width="100%" />
      </div>
    </if>
    <if condition="$special['banner2']">
      <div class="container checkout container-banner2">
          {$special['banner2']}
      </div>
    </if>
            ...
            <div class="div-section pure-g">
              <div class="pure-u-1-3">
                <if condition="$mall['img']">
                    <img class="section-img" data-original="{$mall['img']}" height="60" width="80">
                <else />
              ...
              <div class="pure-u-2-3">
               ...
               <p style="line-height: 17px;color: #969696;font-size: 12px;margin-top: 0px;margin-bottom: 0px;">{$mall['loc']}</p>
